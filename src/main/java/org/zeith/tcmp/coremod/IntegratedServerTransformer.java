package org.zeith.tcmp.coremod;
		...
		implements IClassTransformer
{
	...
	private void patchShareToLAN(String IntegratedServer, boolean obf, MethodNode node)
	{
		...
		insn.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "org/zeith/tcmp/proxy/ClientProxy", "onSharedToLan", "(L" + IntegratedServer + ";I)V", false));
